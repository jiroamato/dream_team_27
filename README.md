...
-   Authors: Shrijaa Venkatasubramanian Subashini, Rahiq Raees, Christine Chow & Jiro Amato
...
3.  Enter the following commands in the terminal inside the JupyterLab instance with project root as the working directory to reset the project to a clean state (i.e., remove all files generated by previous runs of the analysis):
